...
func TestGetAccountTradingStatus(t *testing.T) {
	...
	require.Equal(t, models.StringToFloat32(0.0), resp.FuturesMarginRateMultiplier)
	...
	require.Equal(t, models.StringToFloat32(0.0), resp.SmallNotionalFuturesMarginRateMultiplier)
...
func TestGetAccountBalances(t *testing.T) {
	...
	require.Equal(t, "5YZ55555", resp.AccountNumber)
	require.Equal(t, models.StringToFloat32(51600.762), resp.CashBalance)
	require.Equal(t, models.StringToFloat32(281983.415), resp.LongEquityValue)
	require.Equal(t, models.StringToFloat32(0.0), resp.ShortEquityValue)
	require.Equal(t, models.StringToFloat32(0.0), resp.LongDerivativeValue)
	require.Equal(t, models.StringToFloat32(82680.5), resp.ShortDerivativeValue)
	require.Equal(t, models.StringToFloat32(0.0), resp.LongFuturesValue)
	require.Equal(t, models.StringToFloat32(0.0), resp.ShortFuturesValue)
	require.Equal(t, models.StringToFloat32(0.0), resp.LongFuturesDerivativeValue)
	require.Equal(t, models.StringToFloat32(0.0), resp.ShortFuturesDerivativeValue)
	require.Equal(t, models.StringToFloat32(0.0), resp.LongMargineableValue)
	require.Equal(t, models.StringToFloat32(0.0), resp.ShortMargineableValue)
	require.Equal(t, models.StringToFloat32(452284.177), resp.MarginEquity)
	require.Equal(t, models.StringToFloat32(20078.762), resp.EquityBuyingPower)
	require.Equal(t, models.StringToFloat32(20078.762), resp.DerivativeBuyingPower)
	require.Equal(t, models.StringToFloat32(0.0), resp.DayTradingBuyingPower)
	require.Equal(t, models.StringToFloat32(0.0), resp.FuturesMarginRequirement)
	require.Equal(t, models.StringToFloat32(0.0), resp.AvailableTradingFunds)
	require.Equal(t, models.StringToFloat32(432279.234), resp.MaintenanceRequirement)
	require.Equal(t, models.StringToFloat32(0.0), resp.MaintenanceCallValue)
	require.Equal(t, models.StringToFloat32(0.0), resp.RegTCallValue)
	require.Equal(t, models.StringToFloat32(0.0), resp.DayTradingCallValue)
	require.Equal(t, models.StringToFloat32(0.0), resp.DayEquityCallValue)
	require.Equal(t, models.StringToFloat32(543557.677), resp.NetLiquidatingValue)
	require.Equal(t, models.StringToFloat32(20078.76), resp.CashAvailableToWithdraw)
	require.Equal(t, models.StringToFloat32(0.0), resp.EquityOfferingMarginRequirement)
	require.Equal(t, models.StringToFloat32(0.0), resp.LongBondValue)
	require.Equal(t, models.StringToFloat32(0.0), resp.BondMarginRequirement)
	require.Equal(t, "2023-06-08", resp.SnapshotDate)
	require.Equal(t, models.StringToFloat32(432279.2338), resp.RegTMarginRequirement)
	require.Equal(t, models.StringToFloat32(0.0), resp.FuturesOvernightMarginRequirement)
	require.Equal(t, models.StringToFloat32(0.0), resp.FuturesIntradayMarginRequirement)
	require.Equal(t, models.StringToFloat32(20078.762), resp.MaintenanceExcess)
	require.Equal(t, models.StringToFloat32(0.0), resp.PendingMarginInterest)
	require.Equal(t, models.StringToFloat32(20078.76), resp.EffectiveCryptocurrencyBuyingPower)
...
func TestGetAccountPositions(t *testing.T) {
	...
	require.Equal(t, models.StringToFloat32(0.41), rivn.AverageDailyMarketClosePrice)
	...
	require.Equal(t, models.StringToFloat32(0.0), rivn.RealizedDayGain)
	require.Equal(t, "None", rivn.RealizedDayGainEffect)
	require.Equal(t, "2023-05-24", rivn.RealizedDayGainDate)
	require.Equal(t, models.StringToFloat32(0.0), rivn.RealizedToday)
...
func TestGetAccountBalanceSnapshots(t *testing.T) {
	...
	require.Equal(t, models.StringToFloat32(51600.762), snap.CashBalance)
	require.Equal(t, models.StringToFloat32(281983.965), snap.LongEquityValue)
	require.Equal(t, models.StringToFloat32(0.0), snap.ShortEquityValue)
	require.Equal(t, models.StringToFloat32(0.0), snap.LongDerivativeValue)
	require.Equal(t, models.StringToFloat32(82680.0), snap.ShortDerivativeValue)
	require.Equal(t, models.StringToFloat32(0.0), snap.LongFuturesValue)
	require.Equal(t, models.StringToFloat32(0.0), snap.ShortFuturesValue)
	require.Equal(t, models.StringToFloat32(0.0), snap.LongFuturesDerivativeValue)
	require.Equal(t, models.StringToFloat32(0.0), snap.ShortFuturesDerivativeValue)
	require.Equal(t, models.StringToFloat32(0.0), snap.LongMargineableValue)
	require.Equal(t, models.StringToFloat32(0.0), snap.ShortMargineableValue)
	require.Equal(t, models.StringToFloat32(452284.727), snap.MarginEquity)
	require.Equal(t, models.StringToFloat32(20078.762), snap.EquityBuyingPower)
	require.Equal(t, models.StringToFloat32(20078.762), snap.DerivativeBuyingPower)
	require.Equal(t, models.StringToFloat32(0.0), snap.DayTradingBuyingPower)
	require.Equal(t, models.StringToFloat32(0.0), snap.FuturesMarginRequirement)
	require.Equal(t, models.StringToFloat32(0.0), snap.AvailableTradingFunds)
	require.Equal(t, models.StringToFloat32(432279.047), snap.MaintenanceRequirement)
	require.Equal(t, models.StringToFloat32(0.0), snap.MaintenanceCallValue)
	require.Equal(t, models.StringToFloat32(0.0), snap.RegTCallValue)
	require.Equal(t, models.StringToFloat32(0.0), snap.DayTradingCallValue)
	require.Equal(t, models.StringToFloat32(0.0), snap.DayEquityCallValue)
	require.Equal(t, models.StringToFloat32(4544.727), snap.NetLiquidatingValue)
	require.Equal(t, models.StringToFloat32(20078.76), snap.CashAvailableToWithdraw)
	require.Equal(t, models.StringToFloat32(20078.76), snap.DayTradeExcess)
	require.Equal(t, models.StringToFloat32(0.0), snap.PendingCash)
	require.Equal(t, "None", snap.PendingCashEffect)
	require.Equal(t, models.StringToFloat32(0.0), snap.LongCryptocurrencyValue)
	require.Equal(t, models.StringToFloat32(0.0), snap.ShortCryptocurrencyValue)
	require.Equal(t, models.StringToFloat32(0.0), snap.CryptocurrencyMarginRequirement)
	require.Equal(t, models.StringToFloat32(0.0), snap.UnsettledCryptocurrencyFiatAmount)
	require.Equal(t, "None", snap.UnsettledCryptocurrencyFiatEffect)
	require.Equal(t, models.StringToFloat32(20078.76), snap.ClosedLoopAvailableBalance)
	require.Equal(t, models.StringToFloat32(0.0), snap.EquityOfferingMarginRequirement)
	require.Equal(t, models.StringToFloat32(0.0), snap.LongBondValue)
	require.Equal(t, models.StringToFloat32(0.0), snap.BondMarginRequirement)
	require.Equal(t, "2023-06-08", snap.SnapshotDate)
	require.Equal(t, models.StringToFloat32(432279.0465), snap.RegTMarginRequirement)
	require.Equal(t, models.StringToFloat32(0.0), snap.FuturesOvernightMarginRequirement)
	require.Equal(t, models.StringToFloat32(0.0), snap.FuturesIntradayMarginRequirement)
	require.Equal(t, models.StringToFloat32(20078.762), snap.MaintenanceExcess)
	require.Equal(t, models.StringToFloat32(0.0), snap.PendingMarginInterest)
	require.Equal(t, models.StringToFloat32(20078.76), snap.EffectiveCryptocurrencyBuyingPower)
...
func TestGetAccountNetLiqHistory(t *testing.T) {
	...
	require.Equal(t, models.StringToFloat32(4498.667), liq.Open)
	require.Equal(t, models.StringToFloat32(4498.667), liq.High)
	require.Equal(t, models.StringToFloat32(4498.667), liq.Low)
	require.Equal(t, models.StringToFloat32(4498.667), liq.Close)
	require.Equal(t, models.StringToFloat32(0.0), liq.PendingCashOpen)
	require.Equal(t, models.StringToFloat32(0.0), liq.PendingCashHigh)
	require.Equal(t, models.StringToFloat32(0.0), liq.PendingCashLow)
	require.Equal(t, models.StringToFloat32(0.0), liq.PendingCashClose)
	require.Equal(t, models.StringToFloat32(4498.667), liq.TotalOpen)
	require.Equal(t, models.StringToFloat32(4498.667), liq.TotalHigh)
	require.Equal(t, models.StringToFloat32(4498.667), liq.TotalLow)
	require.Equal(t, models.StringToFloat32(4498.667), liq.TotalClose)
