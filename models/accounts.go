...
// AccountPositionQuery is the optional filtering available for position endpoint
...
// AccountBalanceSnapshotsQuery is the filtering for the account balance snapshots endpoint
