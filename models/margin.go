...
type Holding struct {
	...
	MarginRequirementEffect      constants.PriceEffect `json:"margin-requirement-effect"`
	InitialRequirement           StringToFloat32       `json:"initial-requirement"`
	InitialRequirementEffect     constants.PriceEffect `json:"initial-requirement-effect"`
	MaintenanceRequirement       StringToFloat32       `json:"maintenance-requirement"`
	MaintenanceRequirementEffect constants.PriceEffect `json:"maintenance-requirement-effect"`
	IncludesWorkingOrder         bool                  `json:"includes-working-order"`
	BuyingPower                  StringToFloat32       `json:"buying-power"`
	BuyingPowerEffect            constants.PriceEffect `json:"buying-power-effect"`
...
type MarginRequirements struct {
	...
	MarginEquityEffect           constants.PriceEffect `json:"margin-equity-effect"`
	OptionBuyingPower            StringToFloat32       `json:"option-buying-power"`
	OptionBuyingPowerEffect      constants.PriceEffect `json:"option-buying-power-effect"`
	RegTMarginRequirement        StringToFloat32       `json:"reg-t-margin-requirement"`
	RegTMarginRequirementEffect  constants.PriceEffect `json:"reg-t-margin-requirement-effect"`
	RegTOptionBuyingPower        StringToFloat32       `json:"reg-t-option-buying-power"`
	RegTOptionBuyingPowerEffect  constants.PriceEffect `json:"reg-t-option-buying-power-effect"`
	MaintenanceExcess            StringToFloat32       `json:"maintenance-excess"`
	MaintenanceExcessEffect      constants.PriceEffect `json:"maintenance-excess-effect"`
