...
func TestGetFutures(t *testing.T) {
	...
	require.True(t, decimal.NewFromInt(50).Equal(future.ContractSize))
	require.Equal(t, decimal.NewFromFloat(.25), future.TickSize)
	require.True(t, decimal.NewFromInt(50).Equal(future.NotionalMultiplier))
	require.True(t, decimal.Zero.Equal(future.MainFraction))
	require.True(t, decimal.Zero.Equal(future.SubFraction))
	require.Equal(t, decimal.NewFromFloat(0.01), future.DisplayFactor)
	...
	require.True(t, decimal.NewFromInt(50).Equal(futureProd.NotionalMultiplier))
	require.Equal(t, decimal.NewFromFloat(.25), futureProd.TickSize)
	require.Equal(t, decimal.NewFromFloat(.01), futureProd.DisplayFactor)
	...
	require.Equal(t, decimal.NewFromFloat(.25), future.TickSizes[0].Value)
	require.Equal(t, decimal.NewFromFloat(.05), future.OptionTickSizes[0].Value)
	require.True(t, decimal.NewFromInt(5).Equal(future.OptionTickSizes[0].Threshold))
	require.Equal(t, decimal.NewFromFloat(.05), future.SpreadTickSizes[0].Value)
...
func TestGetFutureOptionProducts(t *testing.T) {
	...
	require.True(t, decimal.NewFromInt(100).Equal(fop.ClearingPriceMultiplier))
	require.Equal(t, decimal.NewFromFloat(0.01), fop.DisplayFactor)
	...
	require.Equal(t, 4, len(futureProd.ListedMonths))
	require.Equal(t, 4, len(futureProd.ActiveMonths))
	require.True(t, decimal.NewFromInt(1).Equal(futureProd.NotionalMultiplier))
	require.Equal(t, decimal.NewFromFloat(.25), futureProd.TickSize)
	require.True(t, decimal.NewFromInt(1).Equal(futureProd.DisplayFactor))
...
func TestGetFutureOptions(t *testing.T) {
	...
	require.True(t, decimal.NewFromInt(2975).Equal(fo.StrikePrice))
	...
	require.True(t, decimal.NewFromInt(1).Equal(fo.FuturePriceRatio))
	require.True(t, decimal.NewFromInt(1).Equal(fo.Multiplier))
	require.True(t, decimal.NewFromInt(1).Equal(fo.UnderlyingCount))
	...
	require.True(t, decimal.NewFromInt(1).Equal(fo.StrikeFactor))
	...
	require.True(t, decimal.NewFromInt(1).Equal(fop.ClearingPriceMultiplier))
...
func TestGetFutureProduct(t *testing.T) {
	...
	require.True(t, decimal.NewFromInt(50).Equal(fp.NotionalMultiplier))
	require.Equal(t, decimal.NewFromFloat(.25), fp.TickSize)
	require.Equal(t, decimal.NewFromFloat(.01), fp.DisplayFactor)
	...
	require.True(t, decimal.NewFromInt(1).Equal(op.ClearingPriceMultiplier))
	require.Equal(t, decimal.NewFromFloat(.01), op.DisplayFactor)
